package valandur.webapi.cache.event;
...
public class CachedDamageSource extends CachedObject<DamageSource> {
    ...
    public CachedCatalogType<DamageType> damageType;


    public CachedDamageSource(DamageSource value) {
        super(value);
        ...
        this.damageType = new CachedCatalogType<>(value.getType());
    }
}
