...
@ApiModel("Event")
public class CachedEvent extends CachedObject<Event> {
    ...
    public CachedEvent(Event value) {
        super(value);

        this.clazz = value.getClass().getName();

        if (value instanceof TargetPlayerEvent) {
        ...
        } else if (value instanceof TargetEntityEvent) {
