...
public class CachedFallingBlockData extends CachedObject<FallingBlockData> {
    ...
    public CachedFallingBlockData(FallingBlockData value) {
        super(value);

        this.state = new CachedBlockState(value.blockState().get());
