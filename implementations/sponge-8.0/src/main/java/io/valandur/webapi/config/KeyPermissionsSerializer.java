...
public class KeyPermissionsSerializer implements TypeSerializer<KeyPermissions> {
    @Override
    public KeyPermissions deserialize(Type type, ConfigurationNode node) throws SerializationException {
    ...
    @Override
    public void serialize(Type type, @Nullable KeyPermissions obj, ConfigurationNode node) throws SerializationException {
        if (obj == null) {
            return;
        }
