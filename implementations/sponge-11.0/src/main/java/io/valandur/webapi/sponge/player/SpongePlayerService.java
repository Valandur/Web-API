...
public class SpongePlayerService extends PlayerService<SpongeWebAPI> {
    ...
    public Collection<Player> getPlayers() {
        var rawPlayers = Sponge.server().onlinePlayers();
        var players = new ArrayList<Player>();
        for (var player : rawPlayers) {
    ...
    public Player toPlayer(org.spongepowered.api.entity.living.player.server.ServerPlayer player) {
    ...
    private ItemStack toItemStack(org.spongepowered.api.item.inventory.ItemStack stack) {
        ...
        var durability = stack.get(Keys.ITEM_DURABILITY).orElse(null);
        var maxDurability = stack.get(Keys.MAX_DURABILITY).orElse(null);
