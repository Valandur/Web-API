...
public class PlayerServlet extends BaseServlet {
  ...
  public Inventory getPlayerInventory(
    ...
    try {
      UUID uuid = UUID.fromString(uuidString);
      return playerService.getPlayerInventory(uuid, type);
    } catch (IllegalArgumentException ignored) {
      throw new BadRequestException("Invalid uuid " + uuidString);
    }
  }
  ...
  public void addToPlayerInventory(
    ...
    try {
      UUID uuid = UUID.fromString(uuidString);
      playerService.addToPlayerInventory(uuid, stacks);
    } catch (IllegalArgumentException ignored) {
      throw new BadRequestException("Invalid uuid " + uuidString);
    }
  }
  ...
  public void removeFromPlayerInventory(
    ...
    try {
      UUID uuid = UUID.fromString(uuidString);
      playerService.removeFromPlayerInventory(uuid, stacks);
    } catch (IllegalArgumentException ignored) {
      throw new BadRequestException("Invalid uuid " + uuidString);
    }
  }
  ...
  public Inventory getPlayerEnderChest(
    ...
    try {
      UUID uuid = UUID.fromString(uuidString);
      return playerService.getPlayerEnderChest(uuid, type);
    } catch (IllegalArgumentException ignored) {
      throw new BadRequestException("Invalid uuid " + uuidString);
    }
  }
  ...
  public void addToPlayerEnderChest(
    ...
    try {
      UUID uuid = UUID.fromString(uuidString);
      playerService.addToPlayerEnderChest(uuid, stacks);
    } catch (IllegalArgumentException ignored) {
      throw new BadRequestException("Invalid uuid " + uuidString);
    }
  }
  ...
  public void removeFromPlayerEnderChest(
    ...
    try {
      UUID uuid = UUID.fromString(uuidString);
      playerService.removeFromPlayerEnderChest(uuid, stacks);
    } catch (IllegalArgumentException ignored) {
      throw new BadRequestException("Invalid uuid " + uuidString);
    }
  }
